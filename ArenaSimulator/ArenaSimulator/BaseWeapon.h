...
public:
	...
	BaseWeapon(std::string name, int atk, WeaponType wepType, DamageType dmgType, WeaponType strType, WeaponType wkType) : 
		weaponName(name), weaponAtk(atk), weaponType(wepType), damageType(dmgType), strongType(strType), weakType(wkType)
	{}
